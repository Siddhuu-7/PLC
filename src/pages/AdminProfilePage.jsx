...
import { AcademicInfoCard } from '../components/acadamicInfocard';
    ...
    async function userDetails() {
      try {
        ...
        const res = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/api/admin/details/?registerNumber=${registerNumber}&admin=${true}}`
        );

        const buffer = await axios.get(
          `${import.meta.env.VITE_BACKEND_URL}/api/admin/pics/?registerNumber=${registerNumber}`,
          {
  ...
  const updateField = async (place, field) => {
    try {
      if (place === "userImg") {
        ...
        await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/admin/update`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      } else {
        await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/admin/update`, {
